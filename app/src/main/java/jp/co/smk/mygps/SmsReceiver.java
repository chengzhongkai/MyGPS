    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            if (extras != null) {
                ...
                for (Object smsEx: smsExtra) {
                    SmsMessage sms = SmsMessage.createFromPdu((byte[]) smsEx);
                    ...
                    if (body.indexOf("getgps")==0) {
                        if(body.indexOf("address")>0){
                            address=body.substring(body.indexOf("address")+"address".length());
                        }
